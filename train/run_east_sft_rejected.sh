...
CUDA_VISIBLE_DEVICES=$GPU ACCELERATE_LOG_LEVEL=info accelerate launch --config_file gpu.yaml sft.py \
    ...
    --logging_steps 5 \
    --output_dir ./model/Llama-3.2-1B-NEW-sft-gsm8k-3epoch-lr2e-6-bs16-rejected_non_linear1 \
    --no_remove_unused_columns \
    --report_to wandb \
    --save_strategy "no" \
    --warmup_ratio 0.1 \
    --use_weighting  \
    --use_rejected_weight_non_linear $EXPONENT \
    --use_rejected_weight_non_linear_coeff $COEFF \
    --bf16 True