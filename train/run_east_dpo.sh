...
ACCELERATE_LOG_LEVEL=info accelerate launch --config_file multigpu.yaml dpo.py \
    ...
    --warmup_ratio 0.1 \
    --use_weighting  \
    --use_entropy_non_linear $ENTROPY_EXPONENT \
    --use_entropy_non_linear_coeff $ENTROPY_COEFF \
    --bf16 True